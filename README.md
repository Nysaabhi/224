...
const nysaFeedData = [
  ...
  },
  {
    ...
    details: {
      ...
      location: "Bangalore (Remote possible)",
...
// Function to show the Nysa Feed overlay
  ...
  return filteredData.map(feed => `
    <div class="nysa-feed-card" onclick="openNysaFeedDetail('${feed.id}')">
      <div class="feed-card-header">
        ...
        <div class="feed-provider-info">
          ...
          <div class="feed-posted-info">
            <i class="far fa-clock"></i> ${feed.details.datePosted}
      ...
      <div class="feed-card-image-container">
        <img src="${feed.details.images[0]}" alt="${feed.details.title}" class="feed-card-image">
        
        ${feed.details.images.length > 1 ? `
          <div class="feed-image-carousel">
      ...
      <div class="feed-card-content">
        ...
        <div class="feed-card-actions">
          <button class="feed-action-button" onclick="event.stopPropagation(); handleFeedAction('${feed.id}')">
            <i class="fas ${getActionIcon(feed.category)}"></i> ${feed.details.actionButton.text}
          </button>
...
function getActionIcon(category) {
  const icons = {
    ...
    'Service Providers': 'fa-concierge-bell'
  };
  ...
  feedPage.innerHTML = `
    ...
    <div class="nysa-feed-detail-content">
      <div class="feed-detail-image-container">
        <img src="${feed.details.images[0]}" alt="${feed.details.title}" class="feed-detail-image">
      </div>
        ...
        <div class="feed-detail-basic-info">
          ...
          <div class="feed-action-section">
            <button class="feed-action-detail-button" onclick="handleFeedAction('${feed.id}')">
              ...
              <span>${feed.details.actionButton.text}</span>
            </button>
          </div>
        </div>
